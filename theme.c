...
INCLUDE_EXTERN_RESOURCE(default_lg_bookmark_entry_png);
...
ThemeImage theme_images[] = {
  ...
  { "lg_bookmark_entry.png", &_binary_resources_default_lg_bookmark_entry_png_start, &lg_bookmark_entry_icon },
