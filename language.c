...
void loadLanguage(int id) {
  ...
  ConfigEntry language_entries[] = {
   ...
   LANGUAGE_ENTRY(BG_ANIM_GIF),
    ...
    LANGUAGE_ENTRY(BG_ANIM_BUBBLES),
    LANGUAGE_ENTRY(BG_ANIM_SNOW),
    LANGUAGE_ENTRY(BG_ANIM_FIREFLIES),
    ...
    LANGUAGE_ENTRY(THEME_LIQUID_GLASS),
   ...
   LANGUAGE_ENTRY(TRANSITION_VERTICAL),
   LANGUAGE_ENTRY(TRANSITION_DIAGONAL)
   };
